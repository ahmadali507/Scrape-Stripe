...
REPLIT_WEBHOOK_URL and REPLIT_WEBHOOK_SECRET are required when new customers are synced.
"""
import os
import logging
import requests
...
def send_new_customers(
    ...
    if not url or not secret:
        logger.error(
            "GoHighLevel webhook required but not configured (set REPLIT_WEBHOOK_URL and REPLIT_WEBHOOK_SECRET)"
        )
        return False
